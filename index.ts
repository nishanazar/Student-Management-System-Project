...
class Student {
  ...
  view_balance() {
    ...
    console.log(
      chalk.green.bold(`Account Balance For ${this.name} : ${this.balance}`))
    ;
    console.log("=".repeat(60));
  }
  ...
  pay_fees(amount: number) {
    this.balance = `Rs. ${(
      parseInt(this.balance.replace(/\D+/g, "")) - amount
    ).toString()}/-`;
    console.log("=".repeat(60));
    console.log(
      chalk.green.bold(`Rs.${amount}/- Fee paid successfully for ${this.name}`)
    );
    console.log(
      chalk.green.bold(`Remaining Balance In Account : ${this.balance}`)
    );
    console.log("=".repeat(60));
  }
...
class Student_manager {
  ...
  enroll_student(student_id: number, course: string) {
    ...
    if (student) {
      ...
      console.log(
        chalk.bold.green(
          `${student.name} successfully enrolled in ${course} course.`
        )
      );
      console.log("=".repeat(60));
    }
